...
def create_dialog(CustomDialogImpl: QtWidgets.QDialog, dialog_name=None, pos=(100, 100)):
    """
    Creates and configures a custom dialog.

    Args:
        CustomDialogImpl (QtWidgets.QDialog): Custom dialog class.
        dialog_name (str): Name of the dialog window. Default is None.
        pos (tuple): Position of the dialog window. Default is (100, 100).

    Returns:
        QtWidgets.QDialog: Created custom dialog.
    """
    ...
    # Read the size and set fixed window size
